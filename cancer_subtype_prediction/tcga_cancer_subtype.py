...
from cancer_subtype_prediction.etl import extract_gene_id_to_name_mapping, extract_gene_id_to_name_mapping_minio
...
from roug_ml.utl.mlflow_utils import (load_top_models, get_best_run, get_top_n_runs, register_n_top_models,
                                      transition_n_models_to_staging, promote_n_models_to_production,
...
class TCGASubtypePredictor:
    ...
    def run(self):
        ...
        transition_n_models_to_staging("cancer_subtype_predictor_ensemble", 10)
        promote_n_models_to_production("cancer_subtype_predictor_ensemble", 10)
